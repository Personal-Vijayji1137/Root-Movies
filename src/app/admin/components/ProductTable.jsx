...
export default async function ProductTable() {
  noStore();
  const result = await Root_Movies_DB(`SELECT movie_id, poster_url, title, release_year, type, language, is_published FROM movie ORDER BY created_at DESC LIMIT 100 OFFSET 0`);
  return (
    <>
